...
trait IHelloStarknet<TContractState> {
    ...
    fn option_result_output(self: @TContractState, val1: u16) -> Result<Order, u16>;
    fn option_result_input(self: @TContractState, inp: Result<Order, u16>) -> u16;
    fn new_types(
        self: @TContractState, ch: ClassHash, eth_addr: EthAddress
    ) -> (ClassHash, EthAddress);
...
mod HelloStarknet {
    ...
    impl IHelloStarknetImpl of super::IHelloStarknet<ContractState> {
        ...
        // return Result<Order>
        fn option_result_output(self: @ContractState, val1: u16) -> Result<Order, u16> {
            if val1 < 100 {
        ...
        fn option_result_input(self: @ContractState, inp: Result<Order, u16>) -> u16 {
            match inp {
                Result::Ok(x) => {
                    return x.p2;
                },
        ...
        fn new_types(
            self: @ContractState, ch: ClassHash, eth_addr: EthAddress
        ) -> (ClassHash, EthAddress) {
            (ch, eth_addr)
        }
