...
// launch with npx ts-node src/scripts/mainnet/2.recoverCompiledContract_4_22.ts
// Coded using Starknet.js v4.22.0
...
async function main() {
    ...
    const compiledContractProxy=await provider.getClassByHash("0x025ec026985a3bf9d0cc1fe17326b245dfdc3ff89b8fde106542a3ea56c5a918");
    fs.writeFileSync('./compiledContracts/ArgentXproxy_0_2_3_1_compressed.json', JSON.stringify(compiledContractProxy,undefined,2));
