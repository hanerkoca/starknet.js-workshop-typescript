...
trait IHelloStarknet<TContractState> {
    ...
    fn emitEventPanic(ref self: TContractState, errorType: u8, errorDescription: felt252);
    // echo Array
...
mod HelloStarknet {
    ...
    impl IHelloStarknetImpl of super::IHelloStarknet<ContractState> {
        ...
        fn emitEventPanic(ref self: ContractState, errorType: u8, errorDescription: felt252) {
            self
                .emit(
                    Event::EventPanic(
                        EventPanic { errorType: errorType, errorDescription: errorDescription,  }
                    )
                );
        }
        // echo Array
