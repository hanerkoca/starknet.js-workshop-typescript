...
This script has been written with cairo v0.10.0, starknet-devnet v0.4.0, starknet.js v4.9.0. Due to fast iterations of Starknet and Cairo, this script will probably be quickly out-of-date.
...
When you see that you have to fund your new wallet, it's automatic in devnet. In other nets, you have to use a faucet or to trasnfert ETH from an existing wallet ; then press enter in the second console ; the script will proceed until end.
