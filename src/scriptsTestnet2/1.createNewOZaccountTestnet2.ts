...
// launch with npx ts-node src/scriptsA2/2.1.createNewOZaccountTestnet.ts
...
async function main() {
    ...
    const privateKeyAX = "0x0721... your account ...15a8"; //testnet2
    const starkKeyPairAX = ec.getKeyPair(privateKeyAX);
    const accountAXAddress: string = "0x2b5... your account ...66e5"; //testnet2
