// https://github.com/authereum/starkware-monorepo/blob/51c5df19e7f98399a2f7e63d564210d761d138d1/packages/starkware-crypto/src/keyDerivation.ts
...
export function getKeyPairFromPath (mnemonic: string, path: string) {
  ...
  //const seed2=  hdkey .fromMasterSeed(seed);
  //const derived=seed2.derivePath(path);
